...
<p align="justify">
This repository provides the source codes that enable the user to record svo inside Isaac Sim simulated environments such that our computer vision algorithms can be tested on and eventuallly benchmarked with other SOTA public algorithms.
</p>
